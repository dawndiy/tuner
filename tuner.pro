...
UBUNTU_TRANSLATION_DOMAIN="tuner.ubuntu-dawndiy"
...
aptest.commands = bash $$PWD/Tuner/tests/autopilot/run
aptest.depends  = sub-Tuner

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Tuner/tests/unit
unittest.depends  = sub-Tuner
